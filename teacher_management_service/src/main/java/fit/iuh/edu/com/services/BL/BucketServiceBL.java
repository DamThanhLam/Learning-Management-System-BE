...
public interface BucketServiceBL {
     ...
     * @return Map<String, String> url, key
     * @throws IOException
     */
    Map<String, String> putObjectToBucket(String bucketName, MultipartFile multipartFile, String ...path) throws ExecutionException, InterruptedException, IOException;
